...
- Cross-language pairing-code tests pin `AB12C-D34EF` to rendezvous `zTn_59YR4I0UaVAJgmJdGDFoOByFrXZpgzlCssnMVHM`. GitHub Actions run `33893777102` passes Android tests/APK, Windows daemon tests/Rust build/Uno publish/package, and Relay tests/build.
